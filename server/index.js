...
var arrays = require('../id_arrays.json');
...
const local = "mongodb://localhost:27017/trendingreviewapp"
MongoClient.connect(local, function(err, db) {
  db.db('trendingreviewapp').createCollection('googleIds', function(err, res) {
    console.log('collection created');
  });

  db.db('trendingreviewapp').createCollection('yelpIds', function(err, res) {
    console.log('collection created');
  });
